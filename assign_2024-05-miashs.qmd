...
- Selon vous, existe-t-il une constance $\kappa$ telle que  $\textsf{MAD}_n \leq \kappa \textsf{IQR}$ ?
Selon vous, existe-t-il une constance $\kappa$ telle que  $\textsf{MAD}_n \geq \kappa \textsf{IQR}$ ?
