...
**Homework 2 (2023-24): Linear regression and Gaussian Linear Modeling**
...
Compute the optimal regression coefficients. What is the distribution of $\widehat{\beta}^*[16 - \mathbb{E}\left[ \widehat{\beta}^*[6] \mid \widehat{\beta}^*[1], \ldots, \widehat{\beta}^*[5] \right]$? Investigate graphically. 
