...
**Science des Données: EST du 2024-06-26 (2 heures)**
...
3. ON connaît un algorithme linéaire pour calculer la médiane empirique d'un échantillon (non trié). Proposer un algorithme linéaire pour calculer $\textsf{MED}_n$$, la déviation absolue médiane d'un échantillon (non trié).
