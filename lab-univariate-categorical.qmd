---
title: 'LAB: Univariate analysis II'
date: "`r Sys.time()`"
...
{{< include recensement_readme.qmd >}}
...
The function `vector2tibble` could be defined using the 
concise piping notation. `.` serves as a pronoun.  
